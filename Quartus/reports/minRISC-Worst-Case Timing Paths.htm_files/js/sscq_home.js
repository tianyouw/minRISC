$(document).ready(function () {
    ...
    $(".open_support").click(function() {
        QUARTUS.open_link("https://www.altera.com/support.html");
        return false;
    });
    ...
    $(".open_web_vs_subscription").click(function() {
        QUARTUS.open_link("https://www.altera.com/content/dam/altera-www/global/en_US/pdfs/literature/po/ss-quartus-comparison.pdf");
        return false;
    });
    ...
    if (mru_projects.length == 0) {
        $("#mru-projects-title").hide();
    }
